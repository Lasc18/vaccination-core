...
import ec.kruger.vaccination.error.PresentationError;
import ec.kruger.vaccination.error.HandleApplicationException;
...
public class GlobalExceptionHandler {
    ...
    public final ResponseEntity<PresentationError> handleException(Exception exception, WebRequest request) {
        log.error("ERROR handleException: %S [DETAIL] %s".formatted(exception.getClass().getSimpleName(), getErrorComplete(exception)));
        return HandleApplicationException.handleApiException(exception, request);
    }
    ...
    public static ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException exception, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        return HandleApplicationException.handleMethodArgumentNotValidException(exception, headers);
    }
